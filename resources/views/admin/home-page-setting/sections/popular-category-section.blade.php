...
{{-- @php
    $popularCategorySection = !empty($popularCategorySection) ? json_decode($popularCategorySection->value) : [];
@endphp
                ...
                @for ($i = 0; $i < 4; $i++)
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="cat_{{ $i + 1 }}" class="form-control main-category">
                                    ...
                                    @foreach ($categories as $category)
                                        <option 
                                            {{ (!empty($popularCategorySection[$i]) && $category->id == $popularCategorySection[$i]->category) ? 'selected' : '' }} 
                                            value="{{ $category->id }}">
                                            {{ $category->name }}
                                        </option>
                                    @endforeach
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                @php
                                    $subCategories = !empty($popularCategorySection[$i]) ? 
                                        \App\Models\SubCategory::where('category_id', $popularCategorySection[$i]->category)->get() : [];
                                @endphp
                                <label>Sub Category</label>
                                <select name="sub_cat_{{ $i + 1 }}" class="form-control sub-category">
                                    <option value="">Select</option>
                                    @foreach ($subCategories as $subCategory)
                                        <option 
                                            {{ (!empty($popularCategorySection[$i]) && $subCategory->id == $popularCategorySection[$i]->sub_category) ? 'selected' : '' }} 
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                @php
                                    $childCategories = !empty($popularCategorySection[$i]) ? 
                                        \App\Models\ChildCategory::where('sub_category_id', $popularCategorySection[$i]->sub_category)->get() : [];
                                @endphp
                                <label>Child Category</label>
                                <select name="child_cat_{{ $i + 1 }}" class="form-control child-category">
                                    <option value="">Select</option>
                                    @foreach ($childCategories as $childCategory)
                                        <option 
                                            {{ (!empty($popularCategorySection[$i]) && $childCategory->id == $popularCategorySection[$i]->child_category) ? 'selected' : '' }} 
